 ...
 *
 * HARD CONSTRAINT: these Zod schemas are preserved verbatim from the original
 * Threadbot full-placement workflow. Do not modify any schema without
 * explicit approval from the pipeline owner.
 */
...
export const PolicyIpGateSchema = z.object({
  ...
  policy: z.object({
    ...
    tool_checks_performed: z.array(z.enum([
...
export const ProductDiscoveryAgentSchema = z.object({
  ...
  product_candidates: z.array(z.object({
    product_id: z.any(),
    name: z.string(),
...
export const ProductSurfacePlannerSchema = z.object({
  ...
  surface_plan: z.object({
    ...
    supported_placements: z.array(z.object({
      placement: z.string(),
      technique: z.string(),
      supported: z.boolean(),
      source: z.string(),
    ...
    required_placements: z.array(z.object({
      placement: z.string(),
      reason: z.enum([
        "required_by_product",
    ...
    optional_placements: z.array(z.object({
      placement: z.string(),
...
export const ProductOptionsResolverSchema = z.object({
  run_id: z.string(),
  required_product_options: z.array(z.object({
    name: z.string(),
    required: z.boolean(),
  ...
  selected_product_options: z.array(z.object({
    name: z.string(),
    value: z.string(),
    selection_reason: z.string(),
...
export const TechnicalQaAgentSchema = z.object({
  ...
  technical_qa: z.object({
    ...
    blocked_placement_jobs: z.array(z.object({
      job_id: z.string(),
      reason: z.string()
    })),
    tool_sources: z.array(z.enum([
...
export const PlacementBundleCompilerSchema = z.object({
  ...
  placement_bundle: z.object({
    ...
    placements: z.array(z.object({
      ...
      generation_mode: z.enum(["generated", "sliced", "derived", "repeated", "mirrored", "blank"]),
      source_job_id: z.string().nullable(),
    ...
    submitted_placement_files: z.array(z.object({
      placement: z.string(),
      file_url: z.string()
    })),
    missing_required_placements: z.array(z.object({
      placement: z.string(),
      reason: z.string()
    }))
  }),
...
export const MockupRenderAgentSchema = z.object({
  ...
  mockup_result: z.object({
    ...
    expected_placement_files: z.array(z.object({
      placement: z.string(),
      required: z.boolean()
    })),
    submitted_placement_files: z.array(z.object({
    ...
    product_options_submitted: z.array(z.object({
      name: z.string(),
      value: z.string()
    })),
